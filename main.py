...
def main(mode):           
    ...
    for row in table_list:  
        ...
        try:               
            ...
            '''
            update_mode = db_module.get_mode(acc_from = row['acc_from'],
                                    acc_to = row['acc_to'],
                                    db_from = row['db_from'],
                                    db_to = row['db_to'],
            ...
            pyjin.print_logging('update_mode is {}'.format(update_mode))
                    
            if update_mode == 'no_table':
